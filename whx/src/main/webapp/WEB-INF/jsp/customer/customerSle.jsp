...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
    <legend style="text-align: center">客户查询界面</legend>
</fieldset>
                        ...
                        <div class="layui-form-item">
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="name" placeholder="请输入需要查询的用户名"
                                           lay-verify="required" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            <button class="layui-btn" lay-submit lay-filter="queryCustemer"
    ...
    <div class="layui-col-md10">
        <form class="layui-form layui-from-pane" action="" style="margin-top:20px">
            <div class="layui-form-item">
                ...
                <div class="layui-inline">
                    <label class="layui-form-label">家属联系人姓名</label>
                    <div class="layui-input-block">
...
<script>
    ...
    layui.use(['table', 'form'], function () {
        ...
        //监听职位查询按钮
        form.on('submit(queryCustemer)', function (data) {
            console.log("----->" + data.field.name);
            table.render({
                elem: '#customer'
                , height: 312
                , url: '<%=contextPath%>/customer/custname?name=' + data.field.name//数据接口
                , page: true //开启分页
                , cols: [[ //表头
